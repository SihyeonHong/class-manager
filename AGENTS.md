...
- **Documentation**: Unless instructed otherwise, when creating documentation or note records, create new `.md` files under the `personal-notes/` directory.
- **Implementation Plans**: Unless instructed otherwise, create implementation plans as `.md` files inside the `personal-notes/` directory.
- **Plan Workflow**:
  1. Write the implementation plan in `personal-notes/`.
